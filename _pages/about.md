...
I hold a Master's degree in physics from Universidade Estadual de Campinas (2019), and a Bachelor's degree in Physics from Universidad Nacional de Colombia (2017). You can find a (probably old) copy of my CV [here](https://andalenavals.github.io/assets/files/academic_cv.pdf), my publications [here](https://scholar.google.com/citations?user=HyzKl44AAAAJ&hl=en), and I invite you to visit my projects [here](https://andalenavals.github.io/forschung/). You can also find the courses I have tutored [here](https://andalenavals.github.io/teaching/) and the packages I have developed [here](https://andalenavals.github.io/packages/) .
